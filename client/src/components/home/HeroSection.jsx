...
const HeroSection = () => {
  return (
    <main className="flex max-w-5xl mx-auto px-4">
        ...
        <div className="flex justify-center items-center gap-14">
          <div className="flex  flex-col items-center text-center lg:text-left gap-6 flex-1">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4">
              <button className="px-8 py-1.5 rounded-full bg-white border border-black/20 hover:bg-white/10 transition">
                Get in touch
              </button>
              <button className="px-8 py-1.5 rounded-full bg-green-700 border border-white/20 text-white  transition">
                View Projects
              </button>
            </div>
          </div>
