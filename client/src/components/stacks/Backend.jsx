...
const Backend = () => {
  const tools = [
    { name: "Node.js", subtitle: "Expert", icon: <FaNodeJs />, color: "#3C873A" },
    { name: "Express.js", subtitle: "Expert", icon: <SiExpress />, color: "#000000" },
  ];

  return (
    <div className="space-y-3 px-4 sm:px-6 md:px-8 lg:px-0">
      <h3 className="text-xl font-semibold text-cyan-400 text-center sm:text-left">Backend</h3>
